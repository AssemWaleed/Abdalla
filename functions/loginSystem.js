...
function pickVideo(n) { // Samir Yasser 5547
    ...
    if (n === 25) { // Aljoo 1551
        ...
        var imageSrc = 'images/profileMan.png';
        var altText = 'avatar';
        var tooltipText = 'Name is  Aljoo , Id is <span style="color:red; cursor:pointer;" >1551</span>';
        var tooltipTextID = '1551';
        addProfileImageAndTooltip(imageSrc, altText, tooltipText, tooltipTextID);
        ...
        var count25 = localStorage.getItem('viewCount25');
        ...
        var watchDiv = document.querySelector('.watch');
        var h3Element25 = document.createElement('h3');
        
        h3Element25.textContent = 'مشاهدات : ' + count25;
        h3Element25.style.textAlign = 'right';
        
        var buttonContainer = document.getElementById('buttonContainer');
        buttonContainer.appendChild(h3Element25);
        ...
        if (count25 >= 3) {
            document.getElementById('error').play();
            alert("لقد انتهت المشاهدات عندك");
            h3Element25.textContent = 'تم انتهاء عدد المشاهدات';
        }
        
        localStorage.setItem('viewCount25', count25);
